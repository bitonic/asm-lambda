// Taken from
// <https://github.com/digital-asset/daml/blob/25f1369cd7f705fec41d2e3c83d04e41dd712a2b/daml-lf/data/src/main/scala/com/digitalasset/daml/lf/data/ImmArray.scala>,
...
object ImmArray {
  ...
  def apply[T](elements: T*): ImmArray[T] = {
